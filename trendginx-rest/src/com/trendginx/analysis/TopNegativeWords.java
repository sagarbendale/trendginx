...
public class TopNegativeWords
{
	...
	public void getRecords(int limit, int req_id)
	{
		...
		try
		{
			topStatement = dbConnection.prepareStatement("SELECT * FROM trendginx.top_neg where req_id = ? order by count desc limit ?");
	...
	public JSONObject getJSON()
	{
		...
		jsResult.put("negativetweets", negative);
		return jsResult;
	}
}
